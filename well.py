class Well:
    """Parent well class."""
    def __init__(self, r, pd, name, dw):
        self.r = r
        self.pd = pd
        self.name = name
        self.dw = dw
...
class Steady(Well):
    ...
    is_steady = True
    is_transient = False
    def __init__(self, r=0.05, q=0.0, pd=1, name='', dw=8):
        super().__init__(r, pd, name, dw)
        self.q = q
...
class Transient(Well):
    ...
    is_steady = False
    is_transient = True
    def __init__(self, r=0.05, ss=None, pd=1, name='', dw=8):
        super().__init__(r, pd, name, dw)
        self.ss = ss
        self.title = self.name
        return
