...
class D1RadConf(Aquifer):
    ...
    is_leaky = False
    is_unconfined = False
    def __init__(self, K=1, Ss=1e-4, B=10, bot=0, dw=8):
        super().__init__(K, B, bot, dw)
        self.Ss = Ss
    ...
    def draw(self):
        ...
        drawing_ratio = 3
        w, h = self.dw, self.dw/drawing_ratio
...
class D1RadUnconf(Aquifer):
    ...
    is_leaky = False
    is_unconfined = True
    def __init__(self, K=1, Sy=0.1, B=10, bot=0, dw=8):
        super().__init__(K, B, bot, dw)
        self.Sy = Sy
...
class D1FiniteConf(Aquifer):
    ...
    is_leaky = False
    is_unconfined = False
    def __init__(self, K=1, Ss=1e-4, B=10, L=1000, bot=0, dw=8):
        super().__init__(K, B, bot, dw)
        self.Ss = Ss
        self.L = L
...
class D1FiniteUnconf(Aquifer):
    ...
    is_leaky = False
    is_unconfined = True
    def __init__(self, K=1, Sy=0.1, B=10, L=1000, bot=0, dw=8):
        super().__init__(K, B, bot, dw)
        self.Sy = Sy
        self.L = L
...
class D1SemifiniteConf(Aquifer):
    """
...
class D1SemifiniteUnconf(Aquifer):
    """
